...
def signup(request):
    ...
    # Send OTP email — fire-and-forget so the view returns immediately
...
def forgot_password_view(request):
    ...
    if "send_reset_link" in request.POST:
        ...
        # Email the OTP — fire-and-forget so the view returns immediately
        ...
        _send_mail_async(
            ...
            message=f"Hi {user.username}, your password reset code is: {otp}",
            from_email=settings.DEFAULT_FROM_EMAIL,
